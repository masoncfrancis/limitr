...
gum confirm "Limitr executables will be built for the following platforms:$platforms_string" --affirmative="Continue" --negative="Exit" || { echo "Limitr build cancelled"; exit 1; }
